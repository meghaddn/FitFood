...
public class MyActivity extends FragmentActivity implements View.OnClickListener, ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    private static final String TAG = "FitFood";
    ...
    // GoogleApiClient wraps our service connection to Google Play
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = buildGoogleApiClient(getApplicationContext());
    ...
    /* onConnected is called when our Activity successfully connects to
Google
     * Play services.  onConnected indicates that an account was selected
on the
     * device, that the selected account has granted any requested
permissions to
     * our app and that we were able to establish a service connection to
Google
     * Play services.
     */
    @Override
...
Google
     * Play services.  onConnectionFailed indicates that the user needs to
select
